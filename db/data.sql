...
insert into bargain (id, item_id, customer_owner_id, assistant_id, future, created, time_end, is_sell, is_closed, start_bet, title, descr)
  ...
  (2, 10020, 1, 3, NULL, current_timestamp, current_timestamp, true, false, 1000, 'Капуста, 500кг', 'Пять центнеров очень вкусной капусты, с той же грядки, что и картофель. В связи с этим возможны следы картофеля, орехов и сока авокадо.'),
  (3, 10020, 1, 3, NULL, current_timestamp, current_timestamp, true, true, 1000, 'Арматура в количестве 100000 штук', 'Завалялась арматура после оборудования дачного участка туалетом. Самовывоз из деревни Гадюкино.'),
